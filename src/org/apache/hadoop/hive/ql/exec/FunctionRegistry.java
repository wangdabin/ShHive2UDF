...
public final class FunctionRegistry {
  ...
  static {
    ...
    /*上海自定义函数函数加载*/
    system.registerUDF("f_integral_number", FIntegralNumber.class, false);
    system.registerUDF("f_income_level_code", FuncIncomeLevelCode.class, false);
    system.registerUDF("f_product_type_id", FuncProductTypeId.class, false);
    system.registerUDF("f_product_type_ws", FuncProductTypeWs.class, false);
    system.registerUDF("f_innet_duration", FuncInnetDuration.class, false);
    system.registerUDF("f_owe_fee_level", FuncOweFeeLevel.class, false);
    system.registerUDF("f_income_level_func", FuncIncomeLevel.class, false);////
    system.registerUDF("f_charge_level", FuncChargeLevel.class, false);
    system.registerUDF("f_3g_charge_level", Func3GChargeLevel.class, false);
    system.registerUDF("f_gw_up_income_level", FuncGWupIncomeLevel.class, false);
    system.registerUDF("f_flux_level", FuncFluxLevel.class, false);
    system.registerUDF("f_product_type_yw", FuncProductTypeYW.class, false);

    system.registerUDF("f_group_onnet_users_lvl", FGroupOnnetUsersLvl.class, false);
    system.registerUDF("f_gw_duration_level", FGWDurationLevel.class, false);
    system.registerUDF("f_group_cust_income_lvl", FGroupCustIncomeLvl.class, false);
    system.registerUDF("f_brand", FBrand.class, false);
    system.registerUDF("f_gw_group_product_type", FGWGroupProductType.class, false);
    system.registerUDF("f_income_level", FIncomeLevel.class, false);//////
    system.registerUDF("f_innet_month_level_gw", FInnetMonthLevelGW.class, false);
    system.registerUDF("f_gw_jf_level", FGwJfLevel.class, false);
    system.registerUDF("f_gw_income_level", FGwIncomeLevel.class, false);
    system.registerUDF("f_gw_innet_time_level", FGwInnetTimeLevel.class, false);
    system.registerUDF("f_3g_eyes_call_counts_lvl", F3GEyesCallCountsLvl.class, false);
    system.registerUDF("f_3g_call_pre_lvl", F3GCallPreLvl.class, false);
    system.registerUDF("f_3g_call_long_lvl", F3GCallLongLvl.class, false);
    
    system.registerUDF("f_add_months", AddMonths.class, false);
    system.registerUDF("f_day_of_week", GetDayOfWeek.class, false);
    system.registerUDF("f_last_day", LastDay.class, false);
    system.registerUDF("f_months_between", Months_Between.class, false);

    system.registerUDF("f_date_add", DateAdd.class, false);
    system.registerUDF("f_istrue_cert_num", FuncUserAge.class, false);
    
    
    system.registerUDF("f_char_to_date", CharToDate.class, false);
    system.registerUDF("f_date_to_char", DateToChar.class, false);
    
    //脱敏函数
    system.registerUDF("f_desen", FuncTuominDesen.class, false);
    system.registerUDF("f_desenlr", FuncTuominDesenLR.class, false);
